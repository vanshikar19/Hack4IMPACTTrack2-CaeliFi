...
const EnergyFlow = () => (<motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="glass rounded-xl p-6">
    ...
    <div className="flex items-center justify-center gap-3 sm:gap-6 flex-wrap">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <span className="text-lg font-bold tabular-nums text-primary">42.8 kW</span>
      </div>
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <span className="text-lg font-bold tabular-nums text-foreground">56.1 kW</span>
      </div>
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <span className="text-lg font-bold tabular-nums text-electric">18.3 kW</span>
      </div>
    </div>
  </motion.div>);
