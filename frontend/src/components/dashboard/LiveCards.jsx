...
const cards = [
    { icon: Sun, label: "Solar Output", value: "42.8", unit: "kW", change: "+12%", up: true, color: "text-primary", bg: "bg-primary/10" },
    { icon: Fuel, label: "DG Output", value: "18.3", unit: "kW", change: "-24%", up: false, color: "text-electric", bg: "bg-electric/10" },
    { icon: Gauge, label: "Load Demand", value: "56.1", unit: "kW", change: "+3%", up: true, color: "text-foreground", bg: "bg-muted" },
    { icon: IndianRupee, label: "Today's Savings", value: "4,280", unit: "₹", change: "+18%", up: true, color: "text-success", bg: "bg-success/10" },
];
const LiveCards = () => (<div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
